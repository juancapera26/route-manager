...
export default function NotificationDropdown() {
  ...
  // Calcular notificaciones no leídas del estado local (no del mock)
  ...
  const handleNotificationClick = (notificacionId: string) => {
    // Marcar como leída (en el futuro esto será una llamada al backend)
  ...
  return (
    <div className="relative">
      ...
      {/* Dropdown con mejor responsividad */}
      <Dropdown
        isOpen={isOpen}
        ...
        className="absolute mt-3 flex h-[480px] flex-col rounded-2xl border border-gray-200 bg-white shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-50
          /* Móviles: Centrado con ancho casi completo */
          right-1/2 translate-x-1/2 w-[calc(100vw-2rem)] max-w-[350px]
          /* Tablets y desktop: Alineado a la derecha */
