...
export default function UserDropdown() {
  const { nombre, apellido, correo, role } = useAuth();
  ...
  const endpointPerfil = role === "1" ? "/admin/profile" : role === "2" ? "/driver/profile" : "/";
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="block mr-4 font-medium text-theme-sm">
        ...
        <ul className="mt-2 flex flex-col gap-1 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            <DropdownItem
              ...
              tag="a"
              to={endpointPerfil}   // 👈 ahora apunta al perfil según rol
